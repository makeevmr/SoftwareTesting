...
TEST(GraphCreation, UndirAdjMatrix_10) {
    ...
    UndirAdjMatrix undir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nCREATION UNDIRECTED ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
...
TEST(GraphCreation, UndirAdjMatrix_100) {
    ...
    UndirAdjMatrix undir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION UNDIRECTED ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphCreation, UndirAdjMatrix_1000) {
    ...
    UndirAdjMatrix undir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION UNDIRECTED ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphCreation, SparseUndirAsjMatrix_10) {
    const int vertices = 10;
    ...
    UndirAdjMatrix undir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nCREATION SPARSE GRAPH ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphCreation, SparseUndirAsjMatrix_100) {
    const int vertices = 100;
    ...
    UndirAdjMatrix undir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION SPARSE GRAPH ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphCreation, SparseUndirAsjMatrix_1000) {
    const int vertices = 1000;
    ...
    UndirAdjMatrix undir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION SPARSE GRAPH ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphCreation, DirAdjMatrix_10) {
    const int vertices = 10;
    ...
    auto start = std::chrono::steady_clock::now();
    DirAdjMatrix dir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION DIRECTED ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphCreation, DirAdjMatrix_100) {
    const int vertices = 100;
    ...
    DirAdjMatrix dir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION DIRECTED ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphCreation, DirAdjMatrix_1000) {
    const int vertices = 1000;
    ...
    DirAdjMatrix dir_graph(edges.begin(), edges.end(), vertices);
    auto end = std::chrono::steady_clock::now();
    std::cout << "\n CREATION DIRECTED ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, TopSort_10) {
    ...
    DirAdjMatrix dir_graph(edges.begin(), edges.end(), vertices);
    std::array<DirAdjMatrixVertexDesc, vertices> result_order;
    auto start = std::chrono::steady_clock::now();
    boost::topological_sort(dir_graph, result_order.begin());
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nTOPSORT ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, TopSort_100) {
    ...
    boost::topological_sort(dir_graph, result_order.begin());
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nTOPSORT ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, TopSort_1000) {
    ...
    boost::topological_sort(dir_graph, result_order.begin());
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nTOPSORT ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, SparseTopSort10) {
    ...
    boost::topological_sort(dir_graph, result_order.begin());
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nSPARSE TOPSORT ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, SparseTopSort100) {
    ...
    boost::topological_sort(dir_graph, result_order.begin());
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nSPARSE TOPSORT ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, SparseTopSort1000) {
    ...
    boost::topological_sort(dir_graph, result_order.begin());
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nSPARSE TOPSORT ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, Dijkstra_10) {
    ...
    std::ifstream input_file("../tests/input/undirected_10.txt");
    ASSERT_TRUE(input_file.is_open());
    WeightedAdjMatrix weighted_graph(vertices);
    uint64_t vertex1 = 0;
    uint64_t vertex2 = 0;
    while (input_file.peek() != EOF) {
        input_file >> vertex1;
    ...
    std::vector<WeightedAdjMatrix::vertex_descriptor> parent(
    ...
    std::cout << "\nDIJKSTRA ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, Dijkstra_100) {
    ...
    std::cout << "\nDIJKSTRA ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, Dijkstra_1000) {
    ...
    std::cout << "\nDIJKSTRA ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
...
TEST(GraphAlgorithms, SparseDijkstra_10) {
    ...
    std::cout << "\nSPARSE DIJKSTRA ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, SparseDijkstra_100) {
    ...
    std::cout << "\nSPARSE DIJKSTRA ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, SparseDijkstra_1000) {
    ...
    std::cout << "\nSPARSE DIJKSTRA ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, BFS_100) {
    ...
    boost::breadth_first_search(undir_graph, 0, boost::visitor(visitor));
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nBFS ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    ASSERT_TRUE(
...
TEST(GraphAlgorithms, BFS_1000) {
    ...
    boost::breadth_first_search(undir_graph, 0, boost::visitor(visitor));
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nBFS ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    ASSERT_TRUE((
...
TEST(GraphAlgorithms, SparseBFS_10) {
    ...
    boost::breadth_first_search(undir_graph, 0, boost::visitor(visitor));
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nSPARSE BFS ADJACENTY MATRIX 10 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, SparseBFS_100) {
    ...
    boost::breadth_first_search(undir_graph, 0, boost::visitor(visitor));
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nSPARSE BFS ADJACENTY MATRIX 100 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
...
TEST(GraphAlgorithms, SparseBFS_1000) {
    ...
    boost::breadth_first_search(undir_graph, 0, boost::visitor(visitor));
    auto end = std::chrono::steady_clock::now();
    std::cout << "\nSPARSE BFS ADJACENTY MATRIX 1000 NODES\n";
    std::cout << "Time: "
              << std::chrono::duration<double, std::milli>(end - start).count()
              << " milliseconds" << "\n\n";
    input_file.close();
